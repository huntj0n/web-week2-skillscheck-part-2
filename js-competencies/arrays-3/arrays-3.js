...
//Code here
var sunsetColors2 = sunsetColors;
function sunset(sunsetColors2){
    let newSunset = [...sunsetColors2];
    if (sunsetColors2[0] !== 'blue'){
        sunsetColors2.splice(0,1, "blue")
    }
    return sunsetColors2
}
sunset(sunsetColors2)
